class interfaz {
  ...
  void draw() {
    ...
    text("\"MAGIA\" "+var1_value, 355, 61); // Barra de var1 - Porcentaje
    image(var2, 205, 75, var2_value*3, 20); // Barra de var2 - Barra
    image(contenedor_var2, 205, 75, 300, 20); // Barra de var2 - Contenedor
    text("EXP. "+var2_value+"% para lvl 2", 355, 92); // Barra de var2 - Porcentaje
    image(box, width-200, 0);
    textSize(60);
    text("MAPA", width-100, 115);
    textSize(25);
    textLeading(20);
    text(quest_title, width-100, 230, 0);
    textSize(18);
    text(quest, width-100, 260);
    textSize(22);
    text(hour()+":"+minute(), 100, 218);
    text(frameRate, 100, 236);
  }
}
